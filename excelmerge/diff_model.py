...
from .constants import (
    ...
    MODE_EMPTY, MODE_DIFF, MODE_PREVIEW, DIR_A2B, DIR_B2A,
)
...
class DiffTableModel(QAbstractTableModel):
    ...
    def cell_kind(self, r: int, c: int) -> str:
        ...
        return "changed" if status in (STATUS_ADDED, STATUS_MODIFIED) else STATUS_SAME
    ...
    def diff_char_ranges(self, r: int, c: int) -> list:
        ...
        if status != STATUS_MODIFIED or a_val == b_val:
            return []
    ...
    def data(self, index, role=Qt.DisplayRole):
        ...
        if role == Qt.BackgroundRole:
            ...
            if status == STATUS_ADDED:
                ...
                return DIFF_COLORS[STATUS_ADDED] if own_val != "" else DIFF_COLORS[STATUS_SAME]
    ...
    def headerData(self, section, orientation, role=Qt.DisplayRole):
        ...
        if (self._mode == MODE_DIFF and self._row_meta
